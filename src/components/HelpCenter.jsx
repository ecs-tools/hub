        ...
        <div className="page-anim" style={{ maxWidth: 720, margin: "0 auto", padding: "40px 32px" }}>
          ...
          {[
            ...
            { section: "Billing Overview", items: [
              { q: "What's in Billing Overview?", a: (<ul style={{ paddingLeft: 18, marginTop: 6 }}><li style={{ marginBottom: 4 }}>One page of financial numbers for the year: <strong>Billed</strong>, <strong>Collected</strong>, <strong>Revenue per day</strong> (billed ÷ client-days attended), <strong>Attendance days</strong>, and what is <strong>past due</strong>.</li><li style={{ marginBottom: 4 }}>Then billed vs collected by month, revenue per day over time, where the money comes from (waiver, county, private pay), billed by center, and the service mix.</li><li style={{ marginBottom: 4 }}><strong>Collected is what the payer actually paid us</strong> — it comes from DODD's own remittance files, not from the billing system's paid column, which runs months behind.</li><li style={{ marginBottom: 4 }}>Recent months look under-collected because they <em>are</em> — payment arrives about three weeks after the service week, so anything newer than that is still in the normal cycle and is <strong>not</strong> late. Only the <strong>Past due</strong> figure is money worth chasing.</li><li style={{ marginBottom: 4 }}>Collections are company-wide and are not broken out per center. Use <strong>Table view</strong> to read every number as text.</li></ul>) },
            ]},
